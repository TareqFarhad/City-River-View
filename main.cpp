...
/*void handleKeypress(unsigned char key, int x, int y) {
	...
	case 'd':
		glutDisplayFunc(day);
		glutPostRedisplay();
		//PlaySound("ship.wav", NULL, SND_ASYNC | SND_FILENAME);  //Me off
		break;
	case 'n':
		glutDisplayFunc(night);
		glutPostRedisplay();
		//PlaySound("ship.wav", NULL, SND_ASYNC | SND_FILENAME);
		break;
...
int main(int argc, char** argv) {
	...
	glutCreateWindow("City River Scenario");
	glutDisplayFunc(day);
